...
(
	student_id serial PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
('Петр', 'Иванов', '2001-02-14', '89243447035'),
('Иван', 'Андреев', '2001-10-03', '89243839028'),
('Илья', 'Петров', '2001-07-28', '89097829370');
